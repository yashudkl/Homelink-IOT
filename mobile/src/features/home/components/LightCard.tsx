...
export const LightCard: React.FC<LightCardProps> = ({ isOn, power, onToggle }) => {
  return (
    <View 
    ...
    >
      <View className="mb-3">
        <MaterialCommunityIcons name="lightbulb-outline" size={28} color="#343434" />
      </View>
      
      <Text className="text-dark text-base font-semibold mb-1">Main Light</Text>
